        ...
        try:
            ...
            try:
                async for old in channel.history(limit=50):
                    if old.author.id == bot.user.id and old.embeds and old.embeds[0].title == "🛡️ ▬▬▬ ПОДАЧА ЗАЯВОК ▬▬▬ 🛡️":
                        await old.delete()
            except Exception:
                pass

            embed = discord.Embed(
                title="🛡️ ▬▬▬ ПОДАЧА ЗАЯВОК ▬▬▬ 🛡️",
                description=(
                    "📌 **РАССМАТРИВАТЬ И ПРИНИМАТЬ ЗАЯВКИ ИМЕЮТ ПРАВО:**\n"
                    "👑 | CEO\n"
                    "⚔️ | GL| ADMIN\n\n"
                    "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    "📝 **КАК ПРАВИЛЬНО ПОДАТЬ ЗАЯВКУ:**\n"
                    "✅ Нажми на кнопку ниже под этим сообщением и заполни анкету.\n"
                    "✅ Дождись ответа — администрация видит абсолютно каждый тикет.\n"
                    "✅ Разрешено подавать максимум 2 заявки в день — этого достаточно.\n\n"
                    "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    "⚠️ **ЧЕГО ДЕЛАТЬ КАТЕГОРИЧЕСКИ НЕ СТОИТ:**\n"
                    "❌ Спамить анкетами — получишь автоматический отказ и ЧС набора.\n"
                    "❌ Пинговать руководство — мы замечаем каждый лог, не отвлекай команду.\n"
                    "❌ Писать в ЛС Лидеру или Замам с вопросами в духе: «Ну когда проверят?».\n\n"
                    "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    "🔨 **НАКАЗАНИЯ ЗА НАРУШЕНИЕ РЕГЛАМЕНТА:**\n"
                    "📎 Флуд анкетами (более 2-х в сутки):\n"
                    "➜ 🔇 Мут на 4 часа + полное удаление всех твоих заявок.\n\n"
                    "📎 Пинг руководства сервера без веской причины:\n"
                    "➜ 1-й раз — ⚠️ Предупреждение\n"
                    "➜ 2-й раз — 🔇 Мут на 1 час\n"
                    "➜ 3-й раз — 🔇 Мут на 12 часов\n\n"
                    "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    "💡 Просто заполнил форму, отправил и спокойно ждёшь — вот и весь секрет. "
                    "Терпение ещё никому не мешало! 😄\n\n"
                    "🛡️ ▬▬▬▬━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 🛡️"
                ),
                color=EMBED_COLOR,
            )
