...
APPLICATIONS = {
    'clan': {
        ...
        'questions': [
            ...
            'Успешные кланы, в которых ты играл(а) (напр. TTteam-тигры)',
        ...
        'fields': [
            ('Активность и поведение', '1) Играть ≥3ч?  3) Быть на связи/помогать тиммейтам?  4) Быть адекватным?', 1000, True, True),
            ('Игровой опыт (кланы)', '2) Успешные кланы, в которых играл(а), напр. TTteam-тигры', 1000, True, True),
            ('Твои данные', '5) Часовой пояс   7) Возраст   9) Твой донат', 400, True, False),
            ('Мотивация', '8) Почему выбрал именно нас?   10) Ник пригласившего', 1000, True, True),
            ('Готовность помогать', '6) Фармить клан коины?   11) Сбор инвентаря с 1-го дня и ивенты?', 1000, True, True),
        ],
    },
    'media': {
        'emoji': '🎥',
