...
APPLICATIONS = {
    'clan': {
        ...
        'color': 0x9b59b6,
        'fields': [
            ('Никнейм / Возраст', 'Например: Player, 17 лет', 100, True, False),
            ('Активность', 'Сколько часов в день/неделю онлайн?', 300, True, False),
            ('Почему хочешь в клан?', 'Кратко о мотивации', 1000, True, True),
            ('Чем можешь быть полезен?', 'Что умеешь, чем поможешь', 1000, False, True),
            ('Дополнительно', 'Любая другая информация (по желанию)', 1000, False, True),
        ],
    },
    'media': {
        'emoji': '🎥',
