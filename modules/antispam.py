...
DRUG_WORDS = [
    "меф", "мет", "амф", "спайс", "гашиш", "кокаин", "героин", "метадон",
    "экстази", "mdma", "lsd", "наркот", "нарко", "мефедрон", "бошк", "гандж",
    "анаш", "марихуан", "каннаб", "психотроп", "закадр", "ширк",
    "мелстрой", "меллстрой", "мелстроев", "мелстрою", "мель",
    "сольвар", "варка", "варк", "варим", "шприц", "амфетамин", "метамфетамин",
    "первитин", "эфедрин", "бошки", "телеграм бот", "t.me", "закладк", "клад",
    "кладмен", "наркота", "наркоман", "солевар", "эйфор", "ломк", "дурь",
    "соль для ванн", "соль для варк",
]
